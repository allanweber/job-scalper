"""Capture mobile-viewport screenshots of M5 (applications + draft detail).

Builds the web app with `lib/main_m5_shots.dart` and drives the pre-installed
...
OUT = ROOT / "screenshots" / "m5"
CHROME = "/opt/pw-browsers/chromium-1194/chrome-linux/chrome"
VIEWPORT = {"width": 390, "height": 844}

# (name, query)
SHOTS = [
    ("applications", "screen=applications&state=ready"),
    ("applications-empty", "screen=applications&state=empty"),
