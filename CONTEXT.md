...
already-normalized Job Postings. See ADR 0001.
...
stored postings against a Profile → render HTML. See ADR 0002.
...
- Data acquisition: API/RSS-first backbone (Remotive, RemoteOK, Arbeitnow, Adzuna, HN,
  4dayweek.io, Authentic Jobs, Findwork, Jobspresso); LinkedIn, Indeed, Wellfound, Arc, Remote.co,
